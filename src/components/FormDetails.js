      ...
      <form onSubmit={onSubmit}>
        ...
        <div className='field' >
          ...
          <div className='inputfield box_middel'>
            ...
            <input className='' type='text' name={'achternaam'} onChange={onChange} value={values.achternaam}/>
          </div>

          <div className='inputfield box_klein' >
            <label>Postcode:</label>
            <input  className='input_klein' pattern='[1-9][0-9]{3}\s?[a-zA-Z]{2}' name={'postcode'} onBlur={onFocusOut} onChange={onChange} value={values.postcode} />
          </div>
          
          <div className='inputfield box_klein'>
            <label >Huisnummer:</label>
            <input className='input_klein' name={'huisnummer'} onChange={onChange} value={values.huisnummer} />
          </div>
          ...
          <div className='inputfield box_groot'>
            <label >Email:</label>
            <input className='' type='email' name={'email'} onChange={onChange} value={values.email} />
          </div>
